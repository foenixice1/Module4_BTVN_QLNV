...
import formatter.BranchFormatter;
...
public class ApplicationConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public void addFormatters(FormatterRegistry registry) {
        registry.addFormatter(new BranchFormatter(applicationContext.getBean(BranchService.class)));
    }
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/FPTEmployee");
  ...
  @Bean
    public EmployeeValidate employeeValidate() {
        return new EmployeeValidate();
    }
